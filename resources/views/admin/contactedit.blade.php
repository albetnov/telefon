                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                @enderror
                                <form id="#" method="POST" action="{{ route('edc', $c_info->slug) }}"
                                    ...
                                    <div class="ml-2 mt-2">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('nama_nomor', $c_info->nama_nomor) }}">
                                                        @error('nama_nomor')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </fieldset>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <textarea
                                                            ...
                                                            rows="10">{{ old('deskripsi', $c_info->deskripsi) }}</textarea>
                                                        @error('deskripsi')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </fieldset>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('alamat', $c_info->alamat) }}">
                                                        @error('alamat')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </fieldset>
                                                    ...
                                                    <fieldset class="form-group">
                                                        <select name="verified"
                                                            ...
                                                            <option value="default"
                                                                {{ $c_info->status === 'default' ? 'selected' : '' }}>-
                                                            </option>
                                                            <option value="verified"
                                                                {{ $c_info->status === 'verified' ? 'selected' : '' }}>Ya
                                                            </option>
                                                        </select>
                                                        @error('verified')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="form-group">
                                            @empty(!$c_info->photo)
                                                ...
                                                <img src="{{ asset('storage/contact') }}/{{ $c_info->photo }}"
                                                    width="200px" alt="image" class="mb-3 mr-1">
                                            @else
